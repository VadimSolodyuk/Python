...
class EmailValidator:
    CHARS_FOR_LOGIN = [x for x in ascii_lowercase + ascii_uppercase + digits + '_' + '.']
    LENGTH_LOGIN = 100
    
    DOMAIN_NAME = '@gmail.com'
    LENGTH_DOMAIN_NAME = 50
    ...
    def get_random_email(cls):
        length = randrange(len(cls.CHARS_FOR_LOGIN) + 1)
        shuffle(cls.CHARS_FOR_LOGIN)
        return ''.join(sample(cls.CHARS_FOR_LOGIN, length)) + cls.DOMAIN_NAME
