...
class MotherBoard:
    ...
    def  get_config(self):
        return [
            ...
            f'Память: {'; '.join(map(lambda mem: f'{mem.name} - {mem.volume}', self.mem_slots))}'
        ]


mb = MotherBoard('mb', CPU('CPU', 2500), Memory('mem_1', 1000), Memory('mem_2', 1500), Memory('mem_3', 1500), Memory('mem_4', 1500), Memory('mem_5', 1500))
print(mb.get_config())